...
**PLE-safe** MLX 4bit weights for Google Gemma 4 E2B (2.3B) on Apple Silicon.
...
- [bf16](https://huggingface.co/FakeRockert543/gemma-4-e2b-it-MLX-bf16)
...
model, processor = load("FakeRockert543/gemma-4-e2b-it-MLX-4bit")
...
git clone https://github.com/FakeRocket543/mlx-gemma4.git
cd mlx-gemma4
python convert_gemma4.py E2B 4
```
