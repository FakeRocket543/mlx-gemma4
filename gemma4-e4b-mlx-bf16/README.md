...
**PLE-safe** MLX bf16 weights for Google Gemma 4 E4B (4.5B) on Apple Silicon.
...
- [8bit](https://huggingface.co/FakeRockert543/gemma-4-e4b-it-MLX-8bit)
- **bf16** ← you are here
...
model, processor = load("FakeRockert543/gemma-4-e4b-it-MLX-bf16")
...
git clone https://github.com/FakeRocket543/mlx-gemma4.git
cd mlx-gemma4
python convert_gemma4.py E4B bf16
```
