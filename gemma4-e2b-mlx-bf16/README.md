...
# gemma-4-e2b-it-MLX-bf16

**PLE-safe** MLX bf16 weights for Google Gemma 4 E2B (2.3B) on Apple Silicon.
...
- [4bit](https://huggingface.co/FakeRockert543/gemma-4-e2b-it-MLX-4bit)
- [8bit](https://huggingface.co/FakeRockert543/gemma-4-e2b-it-MLX-8bit)
- **bf16** ← you are here
...
model, processor = load("FakeRockert543/gemma-4-e2b-it-MLX-bf16")
...
git clone https://github.com/FakeRocket543/mlx-gemma4.git
cd mlx-gemma4
python convert_gemma4.py E2B bf16
```
