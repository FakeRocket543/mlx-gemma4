...
**PLE-safe** MLX 8bit weights for Google Gemma 4 31B (31B dense) on Apple Silicon.
...
- **8bit** ← you are here
- [bf16](https://huggingface.co/FakeRockert543/gemma-4-31b-it-MLX-bf16)
...
model, processor = load("FakeRockert543/gemma-4-31b-it-MLX-8bit")
...
git clone https://github.com/FakeRocket543/mlx-gemma4.git
cd mlx-gemma4
python convert_gemma4.py 31B 8
```
