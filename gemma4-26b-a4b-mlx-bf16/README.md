...
# gemma-4-26b-a4b-it-MLX-bf16

**PLE-safe** MLX bf16 weights for Google Gemma 4 26B-A4B (26B MoE) on Apple Silicon.
...
- [4bit](https://huggingface.co/FakeRockert543/gemma-4-26b-a4b-it-MLX-4bit)
- [8bit](https://huggingface.co/FakeRockert543/gemma-4-26b-a4b-it-MLX-8bit)
- **bf16** ← you are here
...
model, processor = load("FakeRockert543/gemma-4-26b-a4b-it-MLX-bf16")
...
git clone https://github.com/FakeRocket543/mlx-gemma4.git
cd mlx-gemma4
python convert_gemma4.py 26B-A4B bf16
```
