...
**PLE-safe** MLX 4bit weights for Google Gemma 4 26B-A4B (26B MoE) on Apple Silicon.
...
model, processor = load("FakeRockert543/gemma-4-26b-a4b-it-MLX-4bit")
...
git clone https://github.com/FakeRocket543/mlx-gemma4.git
cd mlx-gemma4
python convert_gemma4.py 26B-A4B 4
```
