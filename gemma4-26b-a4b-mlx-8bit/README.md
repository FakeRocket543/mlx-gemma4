...
**PLE-safe** MLX 8bit weights for Google Gemma 4 26B-A4B (26B MoE) on Apple Silicon.
...
- **8bit** ← you are here
- [bf16](https://huggingface.co/FakeRockert543/gemma-4-26b-a4b-it-MLX-bf16)
...
model, processor = load("FakeRockert543/gemma-4-26b-a4b-it-MLX-8bit")
...
git clone https://github.com/FakeRocket543/mlx-gemma4.git
cd mlx-gemma4
python convert_gemma4.py 26B-A4B 8
```
